...
|---------------------------|---------------|-------------------------------------|-----------------------------------|----------|
| Назначение задачи         | Dev/TL        | Неназначенная issue                 | Назначенная issue на разработчика | Задачу может назначить TL, либо разработчик может сам назначить на себя, если у него нет других. Если нет прав назначить на себя заадчу, от можно попросить в комментриях, что хочешь взять на себя - TL назначит |
